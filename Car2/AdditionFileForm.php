...
<body>
    ...
    <div class="content">
        ...
        <form action='AdditionFile.php' method='post'>
            <h2>Add Car to Cart</h2>
            ...
            <input type="text" placeholder="jmilk@yahoo.com" name="email" required><br>
